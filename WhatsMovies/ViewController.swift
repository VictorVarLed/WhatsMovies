...
class ViewController: UIViewController, UIScrollViewDelegate, UITableViewDataSource, UITableViewDelegate {
    ...
    let elements = ["Season 1", "Season 2", "Season 3", "Season 4", "Season 5", "Season 6"];
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell
    {
        ...
        cell.textLabel?.text = elements[row]
    ...
    @IBAction func shamelessActionThatBringsYouToMyTwitterProfile() {
        ...
        if !UIApplication.sharedApplication().openURL(NSURL(string:"twitter://user?screen_name=victorvarled")!){
            UIApplication.sharedApplication().openURL(NSURL(string:"https://twitter.com/victorvarled")!)
        }
    }
}